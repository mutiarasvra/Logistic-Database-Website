               ...
               <div class="work-progres">
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								...
								<input type = "text" class = "form-control" name = "kode_prov">
							</div>
							<div class = "form group">
							...
							<a href = "prov.php" class = "btn btn-warning"> Kembali </a>
					  </form>
				...
				if (isset ($_POST ['save'])) 
				{
					...
					$kode = $_POST ['kode_prov'];
					$kode1 = $_POST ['kode_negara'];
					$prov = $_POST ['provinsi'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO provinsi VALUES ('$kode', '$kode1', '$prov')");
					echo "<br> <div class = 'alert alert-success text-center'> Data berhasil disimpan! </div>";
					echo "<meta http-equiv= 'refresh' content ='1;url=prov.php'>";
				}
				?>
