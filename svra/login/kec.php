	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Data Kecamatan </center> </H1><br>
                            </div>
                            <div class="table-responsive">
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from kecamatan ");							  
							  $ambil1 = mysqli_query($koneksi, "SELECT * from kecamatan, kabkota where kabkota.kode_kabkota=kecamatan.kode_kabkota ") ;
							  ...
							  ?>
                                <tr>
                                  <td><?php echo $isi ['kode_kec'];?></td>
								  <td><?php echo $isi ['kecamatan'];?></td>
								  <td><?php echo $isi1 ['kabkota'];?></td>								  							
									<td>
										<a href = "ubahkec.php?id=<?php echo $isi ['kode_kec'];?> " class="btn btn-primary"> Ubah </a>
										<a href = "hapuskec.php?id=<?php echo $isi ['kode_kec']; ?> " class="btn btn-danger"
										onclick="return confirm ('Apakah Anda yakin ingin menghapus data ini?')"> Hapus </a></td>
								</tr>	
							  <?php }?>
                          </tbody>
                      </table>
					  <a href = "tambahkec.php" class = "btn btn-primary">[+] Tambah </a>
                  </div>
             </div>
      </div>
