	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Jenis Penerima</center> </H1><br>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                  <thead>
                                    <tr>
                                      <th>Kode Jenis Penerima</th>
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from jenis_penerima") ;?> 
							  <?php
							  while ($isi = mysqli_fetch_array($ambil))
							  { ?>
                                <tr>
                                  <td><?php echo $isi ['kode_jenis_penerima'];?></td>
                                  <td><?php echo $isi ['nama_jenis_penerima'];?></td>
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								<label for = "kode_jenis_penerima"> Kode Jenis Penerima </label>
								<input type = "text" class = "form-control" name = "kode_jenis_penerima">
							</div>
							<div class = "form group">
								<label for = "nama_jenis_penerima"> Jenis Penerima </label>
								<input type = "text" class = "form-control" name = "nama_jenis_penerima">
							</div>
							<div class = "form group">
							...
							<a href = "jenispenerima.php" class = "btn btn-warning"> Kembali </a>
					  </form>
					  
				<?php
				if (isset ($_POST ['save'])) {
					$koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
					$kode = $_POST ['kode_jenis_penerima'];
					$njp = $_POST ['nama_jenis_penerima'];
					$ket = $_POST ['keterangan'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO jenis_penerima VALUES ('$kode','$njp', '$ket')");
					echo "<br> <div class = 'alert alert-success text-center'> Data berhasil disimpan! </div>";
					echo "<meta http-equiv= 'refresh' content ='1;url=jenispenerima.php'>";
				}
				?>
