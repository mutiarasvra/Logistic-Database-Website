					...
					<div class="header-left">
							...
							<!--search-box-->
								<div class="search-box">
									<form>
										<input type="text" method = "post" name "cari" placeholder="Search..." required="" autocomplete = "off">	
									...
									include ('config.php');
										...
										if(isset($_GET['cari'])){
										$cari = $_GET['cari'];
										$data = mysqli_query($koneksi, "select * from jenis_pengiriman where nama_jenis_pengiriman like '%$cari%'");				
										}else{
										$data = mysqli_query($koneksi, "select * from jenis_pengiriman");		
										} ?>
								</div><!--//end-search-box-->
