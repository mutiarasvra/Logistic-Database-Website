	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Ubah Data Penerima</center> </H1><br>
                            </div>
                      ...
                      <form method = "POST" enctype = "multipart/form-data">
							...
							<br>
							<div class = "form group">
							<label for = "kode_jenis_penerima"> Jenis Penerima </label>
							...
							<a href = "penerima.php" class = "btn btn-warning"> Kembali </a>
					  </form>
				<?php
				include 'config.php';
				if (isset ($_POST ['save'])) {
					...
					$id = $_GET['id'];
					$njp 	    = $_POST['kode_jenis_penerima'];
					$ket        = $_POST['kode_kel'];
					$tar        = $_POST['nama'];
					$tarr        = $_POST['alamat_lengkap'];
					$query="UPDATE penerima SET kode_jenis_penerima='$njp',kode_kel='$ket',nama='$tar', alamat_lengkap = '$tarr' where kode_penerima='$id'";
					mysqli_query($koneksi, $query);
					echo "<br> <div class = 'alert alert-success text-center'> Data berhasil disimpan! </div>";
					echo "<meta http-equiv= 'refresh' content ='1;url=penerima.php'>";
				}
				?>
