	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
				...
				if (isset ($_POST ['save'])) {
					...
					$kode = $_POST ['kode_penerima'];
					$kode1 = $_POST ['kode_jenis_penerima'];
					$kode2 = $_POST ['kode_kel'];
					$nm = $_POST ['nama'];
					$almt = $_POST ['alamat_lengkap'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO penerima VALUES ('$kode','$kode1', '$kode2', '$nm', '$almt')");
