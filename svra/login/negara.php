	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Negara </center> </H1><br>
                            </div>
                            <div class="table-responsive">
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from negara") ;?> 
							  <?php
							  while ($isi = mysqli_fetch_array($ambil))
							  { ?>
                                <tr>
                                  <td><?php echo $isi ['kode_negara'];?></td>
                                  <td><?php echo $isi ['negara'];?></td>
								  <td>
										<a href = "ubahnegara.php?id=<?php echo $isi ['kode_negara'];?> " class="btn btn-primary"> Ubah </a>
										<a href = "hapusnegara.php?id=<?php echo $isi ['kode_negara']; ?> " class="btn btn-danger"
					  ...
					  <a href = "tambahnegara.php" class = "btn btn-primary">[+] Tambah </a>
                  </div>
             </div>
      </div>
<!--slider menu-->
