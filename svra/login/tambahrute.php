	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                              <div class="chit-chat-heading">
                                <br>  <H1><center> Rute </center> </H1><br>
                            </div>
                            <div class="table-responsive">
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from rute") ;
							   $ambil1 = mysqli_query($koneksi, "SELECT * from rute,jenis_tarif_cakupan where jenis_tarif_cakupan.kode_jenis_tarif_cakupan=rute.kode_jenis_tarif_cakupan ") ;
							   $ambil2 = mysqli_query($koneksi, "SELECT * from rute,kabkota where kabkota.kode_kabkota=rute.kode_kabkota ") ;
							 ?> 
							  <?php
							  while ($isi = mysqli_fetch_array($ambil))
							  {
                                ...
                                <tr>
                                  <td><?php echo $isi ['kode_rute'];?></td>
                                  <td><?php echo $isi2 ['kabkota'];?></td>
                                  <td><?php echo $isi ['kota_B'];?></td> 
							      <td><?php echo $isi1 ['tarif'];?></td> 
								  <td>
										<a href = "ubahrute.php?id=<?php echo $isi ['kode_rute'];?> " class="btn btn-primary"> Ubah </a>
										<a href = "hapusrute.php?id=<?php echo $isi ['kode_rute']; ?> " class="btn btn-danger"
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								<label for = "kode_rute"> Kode </label>
								<input type = "text" class = "form-control" name = "kode_rute">
							</div>
							<br>
							<div class = "form group">
				...
				if (isset ($_POST ['save'])) {
					$koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
					$kode = $_POST ['kode_rute'];
					$kode1 = $_POST ['kode_kabkota'];
					$prov = $_POST ['kota_B'];
					$trf = $_POST ['kode_jenis_tarif_cakupan'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO rute VALUES ('$kode','$kode1', '$prov', '$trf')");
