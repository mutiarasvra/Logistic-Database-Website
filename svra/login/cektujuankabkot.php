			...
			<div class="col-md-8 market-update-gd">
				<div class="market-update-block clr-block-1">
					<div class="col-md-8 market-update-left">
					              <br> <font face = "lucida sans" <b><H1><center> JUMLAH PENERIMA DARI KABUPATEN/KOTA </font></center> </b></H1><br>
                            </div>
				...
				if (isset ($_POST ['check'])) {
					...
					$kja 	    = $_POST['kode_kabkota'];
					$ambil2 = mysqli_query($koneksi, "SELECT * from kabkota where kode_kabkota='$kja'") ;
...
<?php
					...
					$re = $isi1 ['kode_kabkota'];
					$ambil3 = mysqli_query($koneksi, "SELECT * from kecamatan,kabkota where '$re'=kecamatan.kode_kabkota ") ;
					$isi3 = mysqli_fetch_array ($ambil3);
					$ambily = mysqli_query($koneksi, "SELECT * from kabkota where kode_kabkota = '$re' ") ;
					$isiy = mysqli_fetch_array ($ambily);
					$ree = $isi3 ['kode_kec'];
					$ambil4 = mysqli_query($koneksi, "SELECT * from kecamatan,kelurahan where '$ree'=kelurahan.kode_kec ") ;
					$isi4 = mysqli_fetch_array ($ambil4);
					$reee = $isi4 ['kode_kel'];	
					$ambil5 = mysqli_query($koneksi, "SELECT * from penerima where kode_kel ='$reee' ") ;
					...
					<h2><?php echo $isi4 ['kode_kabkota'];?><?php echo " - "?> <?php echo $isiy ['kabkota'];?></h2>
