	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Status Pengiriman</center> </H1><br>
                            </div>
                            <div class="table-responsive">
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from status_pengiriman") ;?> 
							  <?php
							  while ($isi = mysqli_fetch_array($ambil))
							  { ?>
                                <tr>
                                  <td><?php echo $isi ['kode_status'];?></td>
                                  <td><?php echo $isi ['nama_status'];?></td>
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								<label for = "kode_status"> Kode Status Pengiriman </label>
								<input type = "text" class = "form-control" name = "kode_status">
							</div>
							<div class = "form group">
								<label for = "nama_status"> Status Pengiriman </label>
							...
							<a href = "status.php" class = "btn btn-warning"> Kembali </a>
					  </form>
					  
				<?php
				if (isset ($_POST ['save'])) {
					$koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
					$kode = $_POST ['kode_status'];
					$njp = $_POST ['nama_status'];
					$ket = $_POST ['keterangan'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO status_pengiriman VALUES ('$kode','$njp', '$ket')");
