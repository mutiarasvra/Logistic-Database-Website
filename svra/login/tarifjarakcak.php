...
<div class="chit-chat-layer4">
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
							 ...
							 ?> 
							  ...
							  while ($isi = mysqli_fetch_array($ambil))
							  {
                                ...
                                <tr>
								  ...
								  <td>
										<a href = "ubahtjc.php?id=<?php echo $isi ['kode_jenis_tarif_cakupan'];?> " class="btn btn-primary"> Ubah </a>
										<a href = "hapustjc.php?id=<?php echo $isi ['kode_jenis_tarif_cakupan']; ?> " class="btn btn-danger"
					  ...
					  <a href = "tambahtjc.php" class = "btn btn-primary">[+] Tambah </a>
                  </div>
             </div>
      </div>
