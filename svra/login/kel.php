               ...
               <div class="work-progres">
                            ...
                            <div class="table-responsive">
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from kelurahan ");							  
							  $ambil1 = mysqli_query($koneksi, "SELECT * from kecamatan, kelurahan where kecamatan.kode_kec = kelurahan.kode_kec ") ;
							  ...
							  ?>
                                <tr>
                                  <td><?php echo $isi ['kode_kel'];?></td>
								  <td><?php echo $isi ['kelurahan'];?></td>
								  <td><?php echo $isi1 ['kecamatan'];?></td>
								  <td><?php echo $isi1 ['kode_pos'];?></td>								  
									<td>
										<a href = "ubahkel.php?id=<?php echo $isi ['kode_kel'];?> " class="btn btn-primary"> Ubah </a>
										<a href = "hapuskel.php?id=<?php echo $isi ['kode_kel']; ?> " class="btn btn-danger"
										onclick="return confirm ('Apakah Anda yakin ingin menghapus data ini?')"> Hapus </a></td>
								</tr>	
							  <?php }?>
                          </tbody>
                      </table>
					  <a href = "tambahkel.php" class = "btn btn-primary">[+] Tambah </a>
                  </div>
             </div>
      </div>
