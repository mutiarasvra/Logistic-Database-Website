	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Ubah Data Kelurahan</center> </H1><br>
                            </div>
				...
				if (isset ($_POST ['save'])) {
					...
					$id = $_GET['id'];
					$kode1  = $_POST ['kelurahan'];
					$kodee = $_POST ['kode_kec'];
					$kode2 = $_POST ['kode_pos'];
					$query="UPDATE kelurahan SET kelurahan='$kode1',kode_kec='$kodee', kode_pos='$kode2' where kode_kel='$id'";
