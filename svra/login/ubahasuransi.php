	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Ubah Asuransi Pengiriman</center> </H1><br>
                            </div>
				...
				if (isset ($_POST ['save'])) {
					...
					$tar        = $_POST['tarif'];
					$query="UPDATE jenis_asuransi SET nama_jenis_asuransi='$njp',keterangan='$ket',tarif='$tar' where kode_jenis_asuransi='$id'";
