               ...
               <div class="work-progres">
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								<label for = "kode_negara"> Kode </label>
							...
							<a href = "negara.php" class = "btn btn-warning"> Kembali </a>
					  </form>
				...
				if (isset ($_POST ['save'])) {
					...
					$njp = $_POST ['negara'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO negara VALUES ('$kode','$njp')");
					echo "<br> <div class = 'alert alert-success text-center'> Data berhasil disimpan! </div>";
					echo "<meta http-equiv= 'refresh' content ='1;url=negara.php'>";
				}
				?>
