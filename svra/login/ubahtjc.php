	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Ubah Data Tarif Jarak Cakupan</center> </H1><br>
                            </div>
				...
				if (isset ($_POST ['save'])) {
					...
					$id = $_GET['id'];
					$njp 	    = $_POST['kode_jenis_cakupan'];
					$ket        = $_POST['rentang_jarak'];
					$trf        = $_POST['tarif'];
					$query="UPDATE jenis_tarif_cakupan SET kode_jenis_cakupan='$njp',rentang_jarak='$ket', tarif='$trf' where kode_jenis_tarif_cakupan='$id'";
