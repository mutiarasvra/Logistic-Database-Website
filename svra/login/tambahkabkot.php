               ...
               <div class="work-progres">
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								<label for = "kode_kabkota"> Kode Kabupaten/Kota </label>
								<input type = "text" class = "form-control" name = "kode_kabkota">
							</div>
							<div class = "form group">
							...
							<a href = "kabkot.php" class = "btn btn-warning"> Kembali </a>
					  </form>
				...
				if (isset ($_POST ['save'])) {
					...
					$kode = $_POST ['kode_kabkota'];
					$kode1 = $_POST ['kode_prov'];
					$prov = $_POST ['kabkota'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO kabkota VALUES ('$kode','$kode1', '$prov')");
					echo "<br> <div class = 'alert alert-success text-center'> Data berhasil disimpan! </div>";
					echo "<meta http-equiv= 'refresh' content ='1;url=kabkot.php'>";
				}
				?>
