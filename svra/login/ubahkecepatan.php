	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Ubah Data Kecepatan Pengiriman</center> </H1><br>
                            </div>
				...
				if (isset ($_POST ['save'])) {
					...
					$jp			= $_POST['kode_jenis_pengiriman'];
					$njp 	    = $_POST['nama_jenis_pengiriman'];
					$ket        = $_POST['keterangan'];
					$tar        = $_POST['tarif'];
					$query="UPDATE jenis_pengiriman SET kode_jenis_pengiriman='$jp',nama_jenis_pengiriman='$njp',keterangan='$ket',tarif='$tar' where kode_jenis_pengiriman='$jp'";
