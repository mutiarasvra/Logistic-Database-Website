			...
			<div class="col-md-8 market-update-gd">
				<div class="market-update-block clr-block-1">
					<div class="col-md-8 market-update-left">
					              <br> <font face = "lucida sans" <b><H1><center> JUMLAH JENIS PENGIRIMAN YANG SUDAH DIGUNAKAN PELANGGAN </font></center> </b></H1><br>
                            </div>
                            <div class="table-responsive">
                            <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
							<label for = "jenis_asuransi"> Jenis Pengiriman </label>
				...
				if (isset ($_POST ['check'])) {
					...
					$kja 	    = $_POST['kode_jenis_pengiriman'];
					$ambil2 = mysqli_query($koneksi, "SELECT * from jenis_pengiriman where kode_jenis_pengiriman='$kja'") ;
					while ($isi1 = mysqli_fetch_array ($ambil2)){ 
					$re = $isi1 ['kode_jenis_pengiriman'];
					$ambil3 = mysqli_query($koneksi, "SELECT * from resi where kode_jenis_pengiriman='$kja' ") ;
					$isi3 = mysqli_fetch_array ($ambil3);
					$ambil4 = mysqli_query($koneksi, "SELECT * from jenis_pengiriman where kode_jenis_pengiriman='$kja' ") ;
					...
					<table class="table table-hover">
                                  <thead>
                                    <tr>
                                      <th><h2>Kode</h2></th>
									  <th><h2>Jenis Pengiriman </h2></th>
									  <th><h2>Jumlah </h2></th>
                                  </tr>
                              </thead>
					<tbody>
					<tr>
                                <td><h2><?php echo $isi4 ['kode_jenis_pengiriman'];?></h2></td>
                                <td><h2><?php echo $isi4 ['nama_jenis_pengiriman'];?></h2></td>
