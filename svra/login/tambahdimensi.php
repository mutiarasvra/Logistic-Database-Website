	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Dimensi Paket </center> </H1><br>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                  <thead>
                                    <tr>
                                      <th>Kode Jenis Dimensi</th>
                                      <th>Jenis Dimensi</th>                                                          
                                      <th>Keterangan</th>
                                      <th>Tarif</th>
                                  </tr>
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from jenis_dimensi") ;?> 
							  <?php
							  while ($isi = mysqli_fetch_array($ambil))
							  { ?>
                                <tr>
                                  <td><?php echo $isi ['kode_jenis_dimensi'];?></td>
                                  <td><?php echo $isi ['nama_jenis_dimensi'];?></td>
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								<label for = "kode_jenis_dimensi"> Kode Jenis Dimensi </label>
								<input type = "text" class = "form-control" name = "kode_jenis_dimensi">
							</div>
							<div class = "form group">
								<label for = "nama_jenis_dimensi"> Jenis Dimensi </label>
								<input type = "text" class = "form-control" name = "nama_jenis_dimensi">
							</div>
							<div class = "form group">
							...
							<a href = "dimensi.php" class = "btn btn-warning"> Kembali </a>
					  </form>
					  
				<?php
				if (isset ($_POST ['save'])) {
					$koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
					$kode = $_POST ['kode_jenis_dimensi'];
					$njp = $_POST ['nama_jenis_dimensi'];
					$ket = $_POST ['keterangan'];
					$tar = $_POST ['tarif'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO jenis_dimensi VALUES ('$kode','$njp', '$ket','$tar')");
