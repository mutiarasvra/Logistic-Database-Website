			...
			<div class="col-md-8 market-update-gd">
				<div class="market-update-block clr-block-1">
					<div class="col-md-8 market-update-left">
					              <br> <font face = "lucida sans" <b><H1><center> JUMLAH JENIS ASURANSI YANG SUDAH DIGUNAKAN PELANGGAN </font></center> </b></H1><br>
                            </div>
				...
				if (isset ($_POST ['check'])) {
					...
					$kja 	    = $_POST['kode_jenis_asuransi'];
					$ambil2 = mysqli_query($koneksi, "SELECT * from jenis_asuransi where kode_jenis_asuransi='$kja'") ;
					while ($isi1 = mysqli_fetch_array ($ambil2)){ 
					$re = $isi1 ['kode_jenis_asuransi'];
					$ambil3 = mysqli_query($koneksi, "SELECT * from resi where kode_jenis_asuransi='$kja' ") ;
					$isi3 = mysqli_fetch_array ($ambil3);
					$ambil4 = mysqli_query($koneksi, "SELECT * from jenis_asuransi where kode_jenis_asuransi='$kja' ") ;
					...
					<table class="table table-hover">
                                  <thead>
                                    <tr>
                                      <th><h2>Kode</h2></th>
									  <th><h2>Jenis Asuransi </h2></th>
									  <th><h2>Jumlah </h2></th>
                                  </tr>
                              </thead>
					<tbody>
					<tr>
                                <td><h2><?php echo $isi4 ['kode_jenis_asuransi'];?></h2></td>
                                <td><h2><?php echo $isi4 ['nama_jenis_asuransi'];?></h2></td>
