			...
			<div class="col-md-8 market-update-gd">
				<div class="market-update-block clr-block-1">
					<div class="col-md-8 market-update-left">
					              <br>  <b><H1><center> CEK PENGIRIMAN </center> </b></H1><br>
                            </div>
				...
				if (isset ($_POST ['check'])) {
					...
					?> <b> <?php echo "Pengiriman Tanggal  ";?></b><?php
echo					$tgl;?>
<br><br>
					<table class="table table-hover">
							  ...
							  <?php
					$ambil2 = mysqli_query($koneksi, "SELECT * from resi where tanggal_pengiriman='$tgl'") ;
					while ($isi1 = mysqli_fetch_array ($ambil2)){
					$re = $isi1 ['no_resi'];
					$ambil3 = mysqli_query($koneksi, "SELECT * from resi where no_resi='$re' ") ;
					$isin = mysqli_fetch_array ($ambil3);
					$ambil1 = mysqli_query($koneksi, "SELECT * from resi, 
							  penerima where resi.no_resi='$re' and penerima.kode_penerima=resi.kode_penerima ") ;
					$isi1 = mysqli_fetch_array ($ambil1);
					$ambilp = mysqli_query($koneksi, "SELECT * from resi, 
							  paket_barang where resi.no_resi='$re' and paket_barang.kode_paket_barang=resi.kode_paket_barang ") ;
					$isip = mysqli_fetch_array ($ambilp);
					$ambill = mysqli_query($koneksi, "SELECT * from resi, 
							  status_pengiriman where resi.no_resi='$re' and status_pengiriman.kode_status=resi.kode_status ") ;
					$isii = mysqli_fetch_array ($ambill);
					
					?>
					
					<tbody>
					<tr>
					<td> <h4> <center> <font color = "black"><?php echo $isin ['no_resi'];?> </font> </center></td>
					<td> <h4> <center> <font color = "black"><?php echo $isi1 ['nama'];?> </font> </center> </td>
					<td> <h4> <center> <font color = "black"><?php echo $isi1 ['alamat_lengkap'];?> </font></center></td>
					<td> <h4> <center> <font color = "black"><?php echo $isin ['nama_pengirim'];?> </font> </center> </td>
					<td> <h4> <center> <font color = "black"><?php echo $isin ['alamat_pengirim'];?> </font> </center> </td>
					<td> <h4> <center> <font color = "black"><?php echo $isip ['kode_paket_barang'];?> </font></center></td>
					<td> <h4> <center> <font color = "black"><?php echo $isin ['tanggal_sampai'];?> </font> </center> </td>
					<td> <h4> <center> <font color = "black"><?php echo $isin ['total_biaya'];?> </font> </center> </td>
					<td> <h4> <center> <font color = "black"><?php echo $isii ['nama_status'];?> </font></center></td>
					</tr>
