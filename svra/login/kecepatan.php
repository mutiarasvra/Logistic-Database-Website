							...
							<!--search-box-->
								<div class="search-box">
									<form>
										...
										<input type="text" method = "post" name "cari" placeholder="Search..." required="">	
										<input type="submit" name = "cari"value="" >					
									</form>
									<?php if(isset($_POST['cari'])){
									header ("location : carikecepatan.php");}?>
...
<div class="chit-chat-layer4">
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  ...
							  { ?>
                                <tr>
								  ...
								  <td>
										<a href = "ubahkecepatan.php?id=<?php echo $isi ['kode_jenis_pengiriman'];?> " class="btn btn-primary"> Ubah </a>
										<a href = "hapuskecepatan.php?id=<?php echo $isi ['kode_jenis_pengiriman']; ?> " class="btn btn-danger"
					  ...
					  <a href = "tambahkecepatan.php" class = "btn btn-primary">[+] Tambah </a>
                  </div>
             </div>
      </div>
<!--slider menu-->
