			...
			<div class="col-md-8 market-update-gd">
				<div class="market-update-block clr-block-1">
					<div class="col-md-8 market-update-left">
						...
						$id = $_GET['id'];
						$beauty = mysqli_query ($koneksi, "SELECT * from resi where no_resi = '$id'");
						$beast = mysqli_fetch_array ($beauty);?>
						<table class="table table-hover">
                                  <thead>
                                    <tr>
                                      <th><h2>No. Resi </h2></th>
									  <th><h2>Total Biaya</h2></th>
                                  </tr>
                              </thead>
									<tbody>
									<tr>
                                <td><h2><?php echo $beast ['no_resi'];?></h2></td>
                                <td><h2><?php echo $beast ['total_biaya'];?></h2></td>					
									</tr>
								</table>
					</div>
