	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Asuransi Pengiriman</center> </H1><br>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                  <thead>
                                    <tr>
                                      <th>Kode Asuransi Pengiriman</th>
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from jenis_asuransi") ;?> 
							  <?php
							  while ($isi = mysqli_fetch_array($ambil))
							  { ?>
                                <tr>
                                  <td><?php echo $isi ['kode_jenis_asuransi'];?></td>
                                  <td><?php echo $isi ['nama_jenis_asuransi'];?></td>
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								<label for = "kode_jenis_asuransi"> Kode Asuransi Pengiriman </label>
								<input type = "text" class = "form-control" name = "kode_jenis_asuransi">
							</div>
							<div class = "form group">
								<label for = "nama_jenis_pengiriman"> Jenis Asuransi </label>
								<input type = "text" class = "form-control" name = "nama_jenis_asuransi">
							</div>
							<div class = "form group">
							...
							<a href = "asuransi.php" class = "btn btn-warning"> Kembali </a>
					  </form>
					  
				<?php
				if (isset ($_POST ['save'])) {
					$koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
					$kode = $_POST ['kode_jenis_asuransi'];
					$njp = $_POST ['nama_jenis_asuransi'];
					$ket = $_POST ['keterangan'];
					$tar = $_POST ['tarif'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO jenis_asuransi VALUES ('$kode','$njp', '$ket','$tar')");
					echo "<br> <div class = 'alert alert-success text-center'> Data berhasil disimpan! </div>";
					echo "<meta http-equiv= 'refresh' content ='1;url=asuransi.php'>";
				}
				?>
