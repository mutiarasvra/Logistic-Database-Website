	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Ubah Data Kecamatan</center> </H1><br>
                            </div>
				...
				if (isset ($_POST ['save'])) {
					...
					$id = $_GET['id'];
					$kode1  = $_POST ['kecamatan'];
					$kodee = $_POST ['kode_kabkota'];
					$query="UPDATE kecamatan SET kecamatan='$kode1',kode_kabkota='$kodee' where kode_kec='$id'";
