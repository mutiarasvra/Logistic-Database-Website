	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Ubah Data Provinsi</center> </H1><br>
                            </div>
				...
				if (isset ($_POST ['save'])) {
					...
					$id = $_GET['id'];
					$kode1  = $_POST ['provinsi'];
					$kodee = $_POST ['kode_negara'];
					$query="UPDATE provinsi SET provinsi='$kode1',kode_negara='$kodee' where kode_prov='$id'";
