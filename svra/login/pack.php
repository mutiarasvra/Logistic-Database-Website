...
<div class="chit-chat-layer4">
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  ...
							  { ?>
                                <tr>
								  ...
								  <td>
										<a href = "ubahpack.php?id=<?php echo $isi ['kode_jenis_packaging'];?> " class="btn btn-primary"> Ubah </a>
										<a href = "hapuspack.php?id=<?php echo $isi ['kode_jenis_packaging']; ?> " class="btn btn-danger"
					  ...
					  <a href = "tambahpack.php" class = "btn btn-primary">[+] Tambah </a>
                  </div>
             </div>
      </div>
<!--slider menu-->
