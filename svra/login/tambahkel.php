	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Data Kelurahan </center> </H1><br>
                            </div>
                            <div class="table-responsive">
                            					  
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								<label for = "kode_kel"> Kode Kelurahan </label>
								<input type = "text" class = "form-control" name = "kode_kel">
							</div>
							<div class = "form group">
							...
							<a href = "kel.php" class = "btn btn-warning"> Kembali </a>
					  </form>
				...
				if (isset ($_POST ['save'])) {
					...
					$kode = $_POST ['kode_kel'];
					$kode1 = $_POST ['kode_kec'];
					$prov = $_POST ['kelurahan'];
					$kp = $_POST ['kode_pos'];			
					$simpan = mysqli_query ($koneksi, "INSERT INTO kelurahan VALUES ('$kode','$kode1', '$prov', '$kp')");
					echo "<br> <div class = 'alert alert-success text-center'> Data berhasil disimpan! </div>";
					echo "<meta http-equiv= 'refresh' content ='1;url=kel.php'>";
				}
				?>
