	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Cakupan </center> </H1><br>
                            </div>
                            <div class="table-responsive">
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from jenis_cakupan") ;?> 
							  <?php
							  while ($isi = mysqli_fetch_array($ambil))
							  { ?>
                                <tr>
                                  <td><?php echo $isi ['kode_jenis_cakupan'];?></td>
                                  <td><?php echo $isi ['nama_jenis_cakupan'];?></td>
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								<label for = "kode_jenis_cakupan"> Kode  </label>
								<input type = "text" class = "form-control" name = "kode_jenis_cakupan">
							</div>
							<div class = "form group">
								<label for = "nama_jenis_cakupan"> Jenis Cakupan </label>
								<input type = "text" class = "form-control" name = "nama_jenis_cakupan">
							</div>
							<div class = "form group">
							...
							<a href = "cakupan.php" class = "btn btn-warning"> Kembali </a>
					  </form>
					  
				<?php
				if (isset ($_POST ['save'])) {
					$koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
					$kode = $_POST ['kode_jenis_cakupan'];
					$njp = $_POST ['nama_jenis_cakupan'];
					$ket = $_POST ['keterangan'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO jenis_cakupan VALUES ('$kode','$njp', '$ket')");
					echo "<br> <div class = 'alert alert-success text-center'> Data berhasil disimpan! </div>";
					echo "<meta http-equiv= 'refresh' content ='1;url=cakupan.php'>";
				}
				?>
