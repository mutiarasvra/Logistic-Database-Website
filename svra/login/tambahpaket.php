	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Data Paket Barang </center> </H1><br>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-hover">
                                  <thead>
                                    <tr>
                                      <th>Kode Paket Barang</th>
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from paket_barang") ;?> 
							  <?php
							  while ($isi = mysqli_fetch_array($ambil))
							  { ?>
                                <tr>
                                  <td><?php echo $isi ['kode_paket_barang'];?></td>
                                  <td><?php echo $isi ['nama_jenis_paket'];?></td>
                                  <td><?php echo $isi ['deskripsi'];?></td>
								  <td>
										<a href = "ubahpaket.php" class="btn btn-primary"> Ubah </a>
										<a href = "hapuspaket.php" class="btn btn-danger"
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								<label for = "kode_paket_barang"> Kode Paket Barang </label>
								<input type = "text" class = "form-control" name = "kode_paket_barang">
							</div>
							<div class = "form group">
				...
				if (isset ($_POST ['save'])) {
					$koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
					$kode = $_POST ['kode_paket_barang'];
					$nj = $_POST ['jenis_paket'];
					$njp = $_POST ['deskripsi'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO paket_barang VALUES ('$kode','$nj','$njp')");
