               ...
               <div class="work-progres">
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								...
								<input type = "text" class = "form-control" name = "kode_kec">
							</div>
							<div class = "form group">
							...
							<br>
							<div class = "form group">
							<label for = "kode_kabkota"> Kabupaten/Kota </label>
							...
							<a href = "kec.php" class = "btn btn-warning"> Kembali </a>
					  </form>
				...
				if (isset ($_POST ['save'])) {
					...
					$prov = $_POST ['kecamatan'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO kecamatan VALUES ('$kode','$kode1', '$prov')");
					echo "<br> <div class = 'alert alert-success text-center'> Data berhasil disimpan! </div>";
					echo "<meta http-equiv= 'refresh' content ='1;url=kec.php'>";
				}
				?>
