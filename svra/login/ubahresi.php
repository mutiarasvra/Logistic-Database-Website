	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Ubah Data Resi</center> </H1><br>
                            </div>
...
<br>							
				...
				if (isset ($_POST ['save'])) {
					...
					$query="UPDATE resi SET nama_pengirim='$kode1',alamat_pengirim='$kodee', tanggal_pengiriman='$kode2', tanggal_sampai='$kode3', total_biaya='$kodeee', kode_penerima='$kode4',kode_paket_barang='$kode5', kode_jenis_packaging='$kode6',
					kode_jenis_pengiriman='$kode7', kode_jenis_asuransi='$kode8', kode_jenis_tarif_cakupan='$kode9', kode_jenis_dimensi='$kode10',
					kode_status='$kode11' where no_resi='$id'";
