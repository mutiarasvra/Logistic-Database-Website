	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Data Provinsi </center> </H1><br>
                            </div>
                            <div class="table-responsive">
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from provinsi ");							  
							  $ambil1 = mysqli_query($koneksi, "SELECT * from negara, 
							  provinsi where negara.kode_negara=provinsi.kode_negara ") ;
							  while ($isi = mysqli_fetch_array($ambil))
							  { 
							  $isi1 = mysqli_fetch_array($ambil1);
							  ?>
                                <tr>
                                  <td><?php echo $isi ['kode_prov'];?></td>
								  <td><?php echo $isi ['provinsi'];?></td>
									<td><?php echo $isi1 ['negara'];?></td>								  							
									<td>
										<a href = "ubahprov.php?id=<?php echo $isi ['kode_prov'];?> " class="btn btn-primary"> Ubah </a>
										<a href = "hapusprov.php?id=<?php echo $isi ['kode_prov']; ?> " class="btn btn-danger"
										onclick="return confirm ('Apakah Anda yakin ingin menghapus data ini?')"> Hapus </a></td>
								</tr>	
								<?php }?>
                          </tbody>
                      </table>
					  <a href = "tambahprov.php" class = "btn btn-primary">[+] Tambah </a>
                  </div>
             </div>
      </div>
