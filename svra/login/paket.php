							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  ...
							  ?>
                                <tr>
								  ...
								  <td>
										<a href = "ubahpaket.php?id=<?php echo $isi ['kode_paket_barang'];?> " class="btn btn-primary"> Ubah </a>
										<a href = "hapuspaket.php?id=<?php echo $isi ['kode_paket_barang']; ?> " class="btn btn-danger"
										onclick="return confirm ('Apakah Anda yakin ingin menghapus data ini?')"> Hapus </a></td>
								</tr>	
							  <?php }?>
                          </tbody>
                      </table>
					  <a href = "tambahpaket.php" class = "btn btn-primary">[+] Tambah </a>
                  </div>
             </div>
      </div>
