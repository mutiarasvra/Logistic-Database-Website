	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Packaging </center> </H1><br>
                            </div>
                            <div class="table-responsive">
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from jenis_packaging") ;?> 
							  <?php
							  while ($isi = mysqli_fetch_array($ambil))
							  { ?>
                                <tr>
                                  <td><?php echo $isi ['kode_jenis_packaging'];?></td>
                                  <td><?php echo $isi ['nama_jenis_packaging'];?></td>
					  ...
					  <form method = "POST" enctype = "multipart/form-data">
							<div class = "form group">
								<label for = "kode_jenis_packaging"> Kode Packaging </label>
								<input type = "text" class = "form-control" name = "kode_jenis_packaging">
							</div>
							<div class = "form group">
								<label for = "nama_jenis_packaging"> Jenis Packaging </label>
								<input type = "text" class = "form-control" name = "nama_jenis_packaging">
							</div>
							<div class = "form group">
							...
							<a href = "pack.php" class = "btn btn-warning"> Kembali </a>
					  </form>
					  
				<?php
				if (isset ($_POST ['save'])) {
					$koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
					$kode = $_POST ['kode_jenis_packaging'];
					$njp = $_POST ['nama_jenis_packaging'];
					$ket = $_POST ['keterangan'];
					$tar = $_POST ['tarif'];
					$simpan = mysqli_query ($koneksi, "INSERT INTO jenis_packaging VALUES ('$kode','$njp', '$ket','$tar')");
