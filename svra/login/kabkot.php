	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Data Kabupaten/Kota </center> </H1><br>
                            </div>
                            <div class="table-responsive">
							 ...
							 $koneksi= mysqli_connect( $db_host, $db_user, $db_pass, $db_name); 
							  $ambil = mysqli_query ($koneksi, "SELECT * from kabkota ");							  
							  $ambil1 = mysqli_query($koneksi, "SELECT * from provinsi,kabkota where provinsi.kode_prov=kabkota.kode_prov ") ;
							  while ($isi = mysqli_fetch_array($ambil))
							  {
							  $isi1 = mysqli_fetch_array($ambil1);
							  ?>
                                <tr>
                                  <td><?php echo $isi ['kode_kabkota'];?></td>
								  <td><?php echo $isi ['kabkota'];?></td>
								  <td><?php echo $isi1 ['provinsi'];?></td>								  							
									<td>
										<a href = "ubahkabkot.php?id=<?php echo $isi ['kode_kabkota'];?> " class="btn btn-primary"> Ubah </a>
										<a href = "hapuskabkot.php?id=<?php echo $isi ['kode_kabkota']; ?> " class="btn btn-danger"
										onclick="return confirm ('Apakah Anda yakin ingin menghapus data ini?')"> Hapus </a></td>
								</tr>	
							  <?php }?>
                          </tbody>
                      </table>
					  <a href = "tambahkabkot.php" class = "btn btn-primary">[+] Tambah </a>
                  </div>
             </div>
      </div>
