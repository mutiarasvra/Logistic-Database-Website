	 ...
	 <div class="market-updates">
			<div class="col-md-8 market-update-gd">
				...
				if (isset ($_POST ['cek'])) {
					...
					<td> <font color = "black"><?php echo "-";?> </font> </center></td>
					<td> <b> <font color = "black"><?php echo $isi5 ['kabkota'];?> </font> </b> </td>
					<td> <b> <font color = "black"><?php echo $isin ['tarif'];?> </font> </b></td>
					</tr>
					</table>
					<?php	}	?>
					</div>
...
<!--slider menu-->
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="../dashboardddd/send1.php"><i class="fa fa-tachometer"></i><span>SEND</span></a></li>
