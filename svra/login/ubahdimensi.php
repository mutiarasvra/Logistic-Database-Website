	...
	<div class="col-md-10 chit-chat-layer4-center">
               <div class="work-progres">
                            <div class="chit-chat-heading">
                                <br>  <H1><center> Ubah Dimensi Paket</center> </H1><br>
                            </div>
				...
				if (isset ($_POST ['save'])) {
					...
					$tar        = $_POST['tarif'];
					$query="UPDATE jenis_dimensi SET nama_jenis_dimensi='$njp',keterangan='$ket',tarif='$tar' where kode_jenis_dimensi='$id'";
